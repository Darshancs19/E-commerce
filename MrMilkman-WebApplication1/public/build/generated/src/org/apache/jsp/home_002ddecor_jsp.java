...
//
//public final class home_002ddecor_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//      out.write(" \t\t\t\t\t<h2 style=\"text-align: center;\">Home Decor</h2><br>\n");
//      out.write(" \t\t\t\t\t\n");
...
//      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"action\" value=\"home-decor\">\n");
...
//    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${product.getCategory() == 'home decor' }", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
...
//          return true;
//        out.write("</p>\n");
//        out.write("\t\t\t\t\t\t\t\t<div class=\"text-center\">  <a class=\"btn btn-primary\" href=\"Controller?page=addtocart&action=home-decor&id=");
...
//          return true;
//        out.write("\">Add to Cart</a> </div><br>\t\t \t\t\t\t\t</div>\n");
//        out.write(" \t\t\t\t\t\t\t\n");
//        out.write(" \t\t\t\t\t\t");
